...
def create_session(nbr_of_steps: int = 0, nbr_of_images: int = 0) -> Session:
    ...
    session.add_subsession(0, create_subsession(session, 1, Strategy.ALMT, 1, nbr_of_images, "In the next part you will see 3 images at a time."));
    
    # Step 2
    session.add_subsession(1, create_subsession(session, 0, Strategy.MT, 3, nbr_of_images, "In the next part you will see 3 images at a time again, but the images will not be displayed all the time (when it is not displayed you cannot provide feedback)."));
    ...
    # Step 3
    session.add_subsession(2, create_subsession(session, 0, Strategy.MT, 6, nbr_of_images, "In the next part you will see 6 images at a time again, but the images will not be displayed all the time (when it is not displayed you cannot provide feedback)."));
    session.add_subsession(2, create_subsession(session, 1, Strategy.ALMT, 6, nbr_of_images, "In the next part you will see 9 images at a time."));
    
    # Step 4
    session.add_subsession(3, create_subsession(session, 0, Strategy.MT, 9, nbr_of_images, "In the next part you will see 9 images at a time again, but the images will not be displayed all the time (when it is not displayed you cannot provide feedback)."));
    session.add_subsession(3, create_subsession(session, 1, Strategy.ALMT, 9, nbr_of_images, "That was the last part, thank you for your participation in the experiments!"));
